    ...
    <main className="absolute bottom-8 left-8 z-20 max-w-lg">
      <div className="text-left">
        ...
        <p className="text-xs font-light text-white/70 mb-6 leading-relaxed">
          ...
          <br /><br />* Testimonials indicated with an asterisk within this page are shown for illustrative purposes and do not reflect the words of any individual, living or dead
        </p>
