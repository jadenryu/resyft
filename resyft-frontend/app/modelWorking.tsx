...
const trainingData: TrainingExample[] = [
  ...
  { text: "Need to open a bank account.", labels: { account_application: 1 } },
  { text: "Set up direct deposit for my paycheck.", labels: { direct_deposit_form: 1 } },
  { text: "Wire money for house purchase.", labels: { wire_transfer_form: 1 } },
  { text: "Open checking and savings account.", labels: { account_application: 1 } },
  { text: "Transfer funds internationally.", labels: { wire_transfer_form: 1 } },
  { text: "Bank account application.", labels: { account_application: 1 } },
  { text: "Payroll direct deposit setup.", labels: { direct_deposit_form: 1 } },
  { text: "Send wire transfer.", labels: { wire_transfer_form: 1 } },
  { text: "New bank account.", labels: { account_application: 1 } },
  ...
  { text: "Want to open a brokerage account.", labels: { investment_account_application: 1 } },
  { text: "Need to start investing my savings.", labels: { investment_account_application: 1 } },
  { text: "Set up beneficiary for my retirement account.", labels: { beneficiary_designation: 1 } },
  { text: "Update who gets my 401k when I die.", labels: { beneficiary_designation: 1 } },
  { text: "Allow my advisor to trade for me.", labels: { trading_authorization: 1 } },
  { text: "Give trading permission to financial planner.", labels: { trading_authorization: 1 } },
  { text: "Open IRA account.", labels: { investment_account_application: 1 } },
  { text: "Start retirement savings account.", labels: { investment_account_application: 1 } },
  { text: "Change beneficiary on life insurance.", labels: { beneficiary_designation: 1 } },
  { text: "Investment account application.", labels: { investment_account_application: 1 } },
  ...
  { text: "Need to file my tax return.", labels: { form_1040: 1 } },
  { text: "Self-employed consultant need to report business income.", labels: { schedule_c: 1, form_1040: 1 } },
  { text: "Got paid as independent contractor need tax form.", labels: { form_1099_nec: 1 } },
  { text: "Client asking for my taxpayer ID number.", labels: { form_w9: 1 } },
  { text: "Need W-9 form for freelance work.", labels: { form_w9: 1 } },
  { text: "Reporting rental property income.", labels: { form_1099_misc: 1 } },
  { text: "Stock dividends need to report to IRS.", labels: { form_1099_div: 1 } },
  { text: "Bank interest earnings tax form.", labels: { form_1099_int: 1 } },
  { text: "Filing taxes for my small business.", labels: { schedule_c: 1, form_1040: 1 } },
  { text: "Side hustle income tax reporting.", labels: { schedule_c: 1 } },
  { text: "Contractor work taxes.", labels: { form_1099_nec: 1 } },
  { text: "Freelance income taxes.", labels: { form_1099_nec: 1, schedule_c: 1 } },
  ...
  { text: "Car insurance claim after minor fender bender.", labels: { insurance_claim_form: 1 } },
  { text: "Filing claim for home damage from storm.", labels: { insurance_claim_form: 1 } },
  { text: "Dental insurance claim for root canal procedure.", labels: { insurance_claim_form: 1 } },
  { text: "Need COBRA paperwork after being laid off.", labels: { cobra_election_form: 1 } },
  { text: "Want to keep my family's health coverage after termination.", labels: { cobra_election_form: 1 } },
  ...
  { text: "Need money for college.", labels: { scholarship_application: 1, financial_aid_form_fafsa: 1 } },
  { text: "Apply for scholarship.", labels: { scholarship_application: 1 } },
  { text: "Financial aid application.", labels: { financial_aid_form_fafsa: 1 } },
  { text: "FAFSA form.", labels: { financial_aid_form_fafsa: 1 } },
  { text: "Get scholarship for tuition.", labels: { scholarship_application: 1 } },
  { text: "Student loan application.", labels: { financial_aid_form_fafsa: 1 } },
  { text: "Pay for college tuition.", labels: { financial_aid_form_fafsa: 1, scholarship_application: 1 } },
  { text: "Federal student aid.", labels: { financial_aid_form_fafsa: 1 } },
  { text: "College financial help.", labels: { financial_aid_form_fafsa: 1, scholarship_application: 1 } },
  ...
  { text: "Need a passport.", labels: { passport_application_ds11: 1 } },
  { text: "Apply for passport for international travel.", labels: { passport_application_ds11: 1 } },
  { text: "Get TSA PreCheck.", labels: { tsa_precheck_application: 1 } },
  { text: "Fast track airport security.", labels: { tsa_precheck_application: 1 } },
  { text: "Plan my vacation itinerary.", labels: { travel_itinerary: 1 } },
  { text: "First time getting a passport.", labels: { passport_application_ds11: 1 } },
  { text: "Airport security expedited screening.", labels: { tsa_precheck_application: 1 } },
  { text: "Travel to another country.", labels: { passport_application_ds11: 1 } },
  { text: "Skip TSA lines.", labels: { tsa_precheck_application: 1 } },
  ...
  { text: "Apply for a job.", labels: { job_application: 1 } },
  { text: "Need to apply to college.", labels: { college_application: 1 } },
  { text: "Get a car loan.", labels: { loan_application: 1 } },
  { text: "Apply for mortgage loan.", labels: { loan_application: 1 } },
  { text: "Job application form.", labels: { job_application: 1 } },
  { text: "College admission application.", labels: { college_application: 1 } },
  { text: "Personal loan application.", labels: { loan_application: 1 } },
  { text: "Looking for work.", labels: { job_application: 1 } },
  { text: "Getting into university.", labels: { college_application: 1 } },
  { text: "Need to borrow money.", labels: { loan_application: 1 } },
  ...
  { text: "Register to vote.", labels: { voter_registration: 1 } },
  { text: "Register my car.", labels: { vehicle_registration: 1 } },
  { text: "Start a business.", labels: { business_registration: 1 } },
  { text: "DMV vehicle registration.", labels: { vehicle_registration: 1 } },
  { text: "Voter registration form.", labels: { voter_registration: 1 } },
  { text: "Register new car with DMV.", labels: { vehicle_registration: 1 } },
  { text: "Register LLC.", labels: { business_registration: 1 } },
  { text: "Form a company.", labels: { business_registration: 1 } },
  { text: "Election voter registration.", labels: { voter_registration: 1 } },
  { text: "Car title and registration.", labels: { vehicle_registration: 1 } },
